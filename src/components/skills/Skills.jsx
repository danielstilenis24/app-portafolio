  ...
  return (
    <div className='skills' id='skills'>
      ...
      <div className="d-flex justify-content-center d-flex flex-wrap">
        ...
        <div>
          <img className='w-20 mx-auto' src='assets/node.png' alt='HTML icon' />
          <p className='my-4 text-center'>NODE JS</p>
        </div>
        <div>
          <img className='w-20 mx-auto' src='assets/mongo.png' alt='HTML icon' />
          <p className='my-4 text-center'>MONGO DB</p>
        </div>
        <div>
          <img className='w-20 mx-auto' src='assets/git.png' alt='HTML icon' />
          <p className='my-4 text-center'>GIT</p>
        </div>
        <div>
          <img className='w-20 mx-auto' src='assets/angular.png' alt='HTML icon' />
          <p className='my-4 text-center'>ANGULAR</p>
        </div>
        <div>
          <img className='w-20 mx-auto' src='assets/sql.png' alt='HTML icon' />
